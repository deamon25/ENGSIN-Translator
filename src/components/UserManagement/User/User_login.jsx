                            ...
                            <Form className="relative flex flex-col sm:w-[30rem] rounded-lg border-gray-400 bg-white shadow-lg px-4">
                                <div className="flex-auto p-6">
                                    ...
                                    <div className="mb-10 flex flex-shrink-0 flex-grow-0 items-center justify-center overflow-hidden">
                                        <img src={engsinWordwave} className="h-20 mx-auto my-4" alt="#" />
                                    </div>
                                    <h4 className="mb-2 font-medium text-gray-700 xl:text-xl">Welcome to Engsin Wordwave</h4>
                                    ...
                                    <div className="mb-4">
                                        <button
                                            type="submit"
                                            className="grid w-full cursor-pointer select-none rounded-md border bg-[#63b0c9] py-2 px-5 text-center text-white shadow hover:bg-[#5296a7]"
