                ...
                <div className="relative flex flex-col sm:w-[30rem] rounded-lg border-gray-400 bg-white shadow-lg px-4">
                    <div className="flex-auto p-6">
                        ...
                        <form className="mb-4" action="#" method="POST" onSubmit = {handleSubmit}>
                            ...
                            <div className="mb-4">
                                <button className="grid w-full cursor-pointer select-none rounded-md border bg-[#63b0c9] py-2 px-5 text-center align-middle text-sm text-white shadow hover:bg-primaryDark hover:text-white focus:bg-primaryDark focus:text-white focus:shadow-none" type="submit">Reset</button>
                            </div>
                        </form>
